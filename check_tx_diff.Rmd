...
missing_exons = internal_exons_comp[!gene_name %in% missing_genes & is.na(spliceai_ann_exon), .(CHROM, FROM = spliceai_exon_start, TO = spliceai_exon_end, 
...
system('tabix -p bed tool/tool_annotation_files/precomp_supplement_annotation_nochr.sorted.txt.gz')
...
system('tabix -p bed tool/tool_annotation_files/precomp_supplement_annotation_chr.sorted.txt.gz')
...
system('tabix -p bed tool/tool_annotation_files/indel_annotation_nochr.sorted.txt.gz')
...
system('tabix -p bed tool/tool_annotation_files/indel_annotation_chr.sorted.txt.gz')
...
# criteria- 50-200 bp away from splice-site with ref score > 0.05 (or 0.02?)
